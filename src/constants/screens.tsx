...
export const screens = [
  ...
  },
  {
    ...
    spaces: [
      [
        { x: calcVWP(0), y: calcVWP(481) },
        { x: calcVWP(192), y: calcVWP(253) },
        { x: calcVWP(265), y: calcVWP(172) },
        { x: calcVWP(322), y: calcVWP(136) },
        { x: calcVWP(339), y: calcVWP(133) },
        { x: calcVWP(416), y: calcVWP(270) },
        { x: calcVWP(442), y: calcVWP(354) },
        { x: calcVWP(463), y: calcVWP(382) },
        { x: calcVWP(571), y: calcVWP(527) },
        { x: calcVWP(678), y: calcVWP(408) },
        { x: calcVWP(802), y: calcVWP(576) },
        { x: calcVWP(1023), y: calcVWP(920) },
        { x: calcVWP(1), y: calcVWP(922) },
      ],
      [
        { x: calcVWP(944), y: calcVWP(921) },
        { x: calcVWP(1046), y: calcVWP(532) },
        { x: calcVWP(1150), y: calcVWP(437) },
        { x: calcVWP(1209), y: calcVWP(392) },
        { x: calcVWP(1308), y: calcVWP(494) },
        { x: calcVWP(1394), y: calcVWP(567) },
        { x: calcVWP(1475), y: calcVWP(612) },
        { x: calcVWP(1513), y: calcVWP(518) },
        { x: calcVWP(1557), y: calcVWP(363) },
        { x: calcVWP(1650), y: calcVWP(278) },
        { x: calcVWP(1789), y: calcVWP(398) },
        { x: calcVWP(1851), y: calcVWP(527) },
        { x: calcVWP(1904), y: calcVWP(746) },
        { x: calcVWP(1920), y: calcVWP(784) },
      ]
    ] as Point[][],
