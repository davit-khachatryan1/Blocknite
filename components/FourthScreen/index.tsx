...
const FourthScreen = () => {
    ...
    const startAnimation = (control: any, animation: any) => {
    ...
    useEffect(() => {
        ...
        if (!scrolling) {
            if (inViewFirstBlock1) {
                startAnimation(segments.Orange, animations.first)
                newAnimations.first.isValue = true;
            }

            if (inViewFirstBlock2) {
                startAnimation(segments.Green, animations.fourth)
                newAnimations.fourth.isValue = true;
            }

            if (inViewFirstBlock3) {
                startAnimation(segments.Yellow, animations.third)
                newAnimations.third.isValue = true;
            }

            if (inViewFirstBlock4) {
                startAnimation(segments.Red, animations.second)
