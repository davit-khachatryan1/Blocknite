...
export const calcVW = (value: string | number, windowWidth=0, mobileValue?: number) => {
...
export const calcVWP = (value: string | number, windowWidth=0) => {
...
export const calcVWD = (value: string | number, windowWidth=0, mobileValue?: number) => {
    const mediaValue = windowWidth <= 576 && mobileValue ? mobileValue : value
